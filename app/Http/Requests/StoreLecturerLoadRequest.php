...
class StoreLecturerLoadRequest extends FormRequest
{
    /**
        ...
        return [
            'max_load' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if (LecturerLoad::exists()) {
                        $fail('A lecturer load configuration already exists. Please edit the existing configuration instead.');
                    }
                },
            ],
        ];
